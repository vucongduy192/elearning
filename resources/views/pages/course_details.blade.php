                                    ...
                                    <div class="cur_item_content">
                                        ...
                                        <div class="pull-right">
                                            <div class="form-group template-checkbox">
                                                @if($has_enrolled)
                                                <input class="process" type="checkbox" name="module{{ $module->id }}"
                                                    id="module{{ $module->id }}"
                            ...
                            <div class="review new-review">
                                <form method="POST" action="#" class="review-form">
                                    ...
                                    <input type="hidden" name="student_id"
                                        value="{{ \Illuminate\Support\Facades\Auth::user()->student->id }}">
                                    <div class="form-group row">
                                        <textarea id="content"
                                            class="form-control @error('content') is-invalid @enderror" name="content"
                                            value="{{ old('content') }}" rows="3"></textarea>
                                ...
                                <div class="like_item d-flex flex-row align-items-end justify-content-start">
                                    <div class="like_title_container">
                                        <div class="like_title">
                                            <a href="{{route('courses.show', ['id' => $r_c->id])}}" target="_blank"
                                                style="color: #000;">{{ $r_c->name }}</a>
                                        </div>
