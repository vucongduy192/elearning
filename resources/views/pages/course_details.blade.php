...
@section('content')
    ...
    <div class="intro">
        <img class="intro_background parallax-window" data-parallax="scroll"
             src="{{ asset('front-end/images/intro.jpg') }}" data-speed="0.8" alt="">
        <div class="container">
            <div class="row">
                <div class="col">
                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div
                                            ...
                                            <div class="instructor_content">
                                                <div class="instructor_name"><a href="instructors.html">{{ $course->teacher->user->name }}</a>
                                                </div>
                                ...
                                <div class="curriculum_items">
                                    ...
                                    <div class="cur_item">
                                        <div
                                            ...
                                            <div class="cur_title">{{ $lecture->name }}</div>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li class="d-flex flex-row align-items-center justify-content-start">
                                                                ...
                                                                <span>Video:
                                                                    <a href="{{ route('lectures.show', ['id' => $lecture->id]) }}">Greetings and Introductions</a>
                                                                </span>
                                                                <div class="cur_time ml-auto">
                                                                    <i class="fa fa-clock-o" aria-hidden="true"></i><span>15 minutes</span>
                                                                </div>
                                                            </li>
                                                            <li class="d-flex flex-row align-items-center justify-content-start">
                                                                <i class="fa fa-file" aria-hidden="true"></i>
                                                                <span>Reading:
                                                                    <a href="{{ route('lectures.show', ['id' => $lecture->id]) }}">Word Types</a>
                                                                </span>
                                                                <div class="cur_time ml-auto">
                                                                    <i class="fa fa-clock-o" aria-hidden="true"></i><span>15 minutes</span>
                                                                </div>
                            ...
                            <div id="reviews" class="tab-pane tab_panel reviews fade">
                                ...
                                <div class="cur_ratings_container clearfix">
                                    <div
                                        class="cur_rating d-flex flex-column align-items-center justify-content-center">
                                ...
                                <div class="features_content">
                                    <ul class="features_list">
                                        ...
                                        <li class="d-flex flex-row align-items-start justify-content-start">
                                            ...
                                            <div class="feature_text ml-auto">{{ count($course->lectures) }} weeks</div>
                                        </li>
                                        ...
                                        <li class="d-flex flex-row align-items-start justify-content-start">
                                            ...
                                            <div class="feature_text ml-auto">{{ count($course->lectures) }}</div>
                                        </li>

                                        <!-- Feature -->
                                        <li class="d-flex flex-row align-items-start justify-content-start">
                                            <div class="feature_title"><i class="fa fa-user" aria-hidden="true"></i><span>Enrolled</span>
                                            </div>
