        ...
        <div class="col-xs-12">
            <div class="box box-info">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <router-link :to="{ name: 'main.rule.add' }" class="btn btn-success">
                                Add new rule
                            </router-link>
                            ...
                            <table class="table table-bordered table-hover no-padding">
                                <thead>
                                    <tr>
                                        ...
                                        <th id="cat_id1" @click="clickSort('cat_id1')">
                                            Category <i class="sort"></i>
                                        </th>
                                        <th id="cat_id2" @click="clickSort('cat_id2')">
                                            Category <i class="sort"></i>
                                        </th>
                                        <th id="weight" @click="clickSort('weight')">
                                            Weight <i class="sort"></i>
                                        </th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
